...
pedro = Speaker.create first_name: "Pedro", last_name: "Belo",
  twitter: "pedro", company: "Heroku"
jano = Speaker.create first_name: "Nicolás", last_name: "Sanguinetti",
  twitter: "godfoca"
apotonick = Speaker.create first_name: "Nick", last_name: "Suterer",
  twitter: "apotonick"
wynn = Speaker.create first_name: "Wynn", last_name: "Netherland",
  twitter: 'pengwynn', company: "Github"
